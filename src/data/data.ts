...
const refinedData: Data[] = data.map((el) => {
    return (
        {
            "Alcohol": (el["Alcohol"]),
            "Malic Acid": Number(el["Malic Acid"]),
            "Ash": Number(el["Ash"]),
            "Alcalinity of ash": Number(el["Alcalinity of ash"]),
            "Magnesium": Number(el["Magnesium"]),
            "Total phenols": Number(el["Total phenols"]),
            "Flavanoids": Number(el["Flavanoids"]),
            "Nonflavanoid phenols": Number(el["Nonflavanoid phenols"]),
            "Proanthocyanins": Number(el["Proanthocyanins"]),
            "Color intensity": Number(el["Color intensity"]),
            "Hue": Number(el["Hue"]),
            "OD280/OD315 of diluted wines": Number(el["OD280/OD315 of diluted wines"]),
            "Unknown": Number(el["Unknown"]),
            "Gamma": (Number(el["Ash"]) * Number(el['Hue'])) / Number(el['Magnesium'])
        }
    )
})
